...
//Identify: 86a4738b31c0ea2a1aeef868c1287b7c
...
Online activity',
  ...
  'archiverredirect' => '0',
  'attachbanperiods' => '',
  'attachdir' => 'C:/wamp/www/./data/attachment/',
  'attachexpire' => '',
  'attachimgpost' => '1',
  'attachrefcheck' => '0',
  'attachsave' => '3',
  'attachurl' => 'data/attachment/',
  'authkey' => '0cde0b4QH2noPxNG',
  'authoronleft' => '1',
  'uidlogin' => '0',
  'autoidselect' => '0',
  'avatarmethod' => '0',
...
{time}',
  ...
  'transferstatus' => true,
  'ucenterurl' => 'http://localhost:8088/uc_server',
  'tradeopen' => 1,
  'medalstatus' => 0,
  'specialicon' => 
  array (
  ...
  'menunavs' => 
  array (
    0 => '<div class="p_pop h_pop" id="mn_userapp_menu" style="display: none"></div>',
  ),
  'subnavs' => 
  array (
    'mn_userapp' => '',
  ...
  array (
    ...
    array (
      ...
      'navid' => 'mn_userapp',
      'level' => '0',
      'nav' => 'id="mn_userapp" onmouseover="delayShow(this, function () {showMenu({\'ctrlid\':\'mn_userapp\',\'pos\':\'43!\',\'ctrlclass\':\'a\',\'duration\':2});showUserApp();})"><a href="userapp.php" hidefocus="true" title="Manyou"  ',
    ),
    6 => 
    array (
      'id' => '6',
  ...
  array (
    ...
    array (
      'available' => '1',
      'navname' => 'Friends',
      'code' => '<a href="home.php?mod=space&do=friend" style="background-image:url(http://localhost:8088/static/image/feed/friend_b.png) !important">',
      'level' => '0',
      'id' => 'friend',
    ),
    'thread' => 
    array (
      'available' => '1',
      'navname' => 'Threads',
      'code' => '<a href="forum.php?mod=guide&view=my" style="background-image:url(http://localhost:8088/static/image/feed/thread_b.png) !important">',
      'level' => '0',
      'id' => 'thread',
    ),
    'favorite' => 
    array (
      'available' => '1',
      'navname' => 'Favorites',
      'code' => '<a href="home.php?mod=space&do=favorite&view=me" style="background-image:url(http://localhost:8088/static/image/feed/favorite_b.png) !important">',
      'level' => '0',
      'id' => 'favorite',
    ),
    'magic' => 
    array (
      'available' => '1',
      'navname' => 'Magics',
      'code' => '<a href="home.php?mod=magic" style="background-image:url(http://localhost:8088/static/image/feed/magic_b.png) !important">',
      'level' => '0',
      'id' => 'magic',
    ),
    'medal' => 
    array (
      'available' => '1',
      'navname' => 'Medals',
      'code' => '<a href="home.php?mod=medal" style="background-image:url(http://localhost:8088/static/image/feed/medal_b.png) !important">',
      'level' => '0',
      'id' => 'medal',
    ),
    'task' => 
    array (
      'available' => '1',
      'navname' => 'Tasks',
      'code' => '<a href="home.php?mod=task" style="background-image:url(http://localhost:8088/static/image/feed/task_b.png) !important">',
      'level' => '0',
      'id' => 'task',
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'code' => '<a href="javascript:;"  onclick="setHomepage(\'http://localhost:8088/\');">',
        'type' => '0',
        'level' => '0',
        'id' => 'sethomepage',
      ),
      ...
      array (
        ...
        'code' => '<a href="http://localhost:8088/"  onclick="addFavorite(this.href, \'Discuz! Board\');return false;">',
        'type' => '0',
        'level' => '0',
        'id' => 'setfavorite',
      ),
...
{wrOpNWI6}
<dl class="pil cl">
	<dt>{I169qqK7}</dt><dd>{bino5Iqe}</dd>
</dl>
{jQ20hkk7}
<dl class="pil cl">{q46ixk75}</dl>',
        'top' => '<dl class="cl">
<dt>{cJqmoEbg}</dt><dd>{qu68s57u}</dd>
</dl>',
      ),
    ),
    'code' => 

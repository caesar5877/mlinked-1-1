...
<!--vot-->					( 会员: <strong><?php echo $membercount;?></strong>, 隐身: <strong><?php echo $invisiblecount;?></strong>,
<!--vot-->					位游客: <strong><?php echo $guestcount;?></strong> )
<!--vot-->					- 最高记录是: <strong><?php echo $onlineinfo['0'];?></strong> 于 <strong><?php echo $onlineinfo['1'];?></strong>.</span>
</h3>

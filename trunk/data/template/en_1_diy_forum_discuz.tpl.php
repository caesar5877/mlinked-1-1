...
<div id="an">
<dl class="cl">
<dt class="z xw1">Announcement:&nbsp;</dt>
<dd>
...
<?php } ?>
<div class="z">
<a href="./" class="nvhm" title="Website"><?php echo $_G['setting']['bbname'];?></a><em>&raquo;</em><a href="forum.php"><?php echo $_G['setting']['navs']['2']['navname'];?></a><?php echo $navigation;?>
</div>
...
<p class="chart z">Today: <em><?php echo $todayposts;?></em><span class="pipe">|</span>Yesterday: <em><?php echo $postdata['0'];?></em><span class="pipe">|</span>Posts: <em><?php echo $posts;?></em><span class="pipe">|</span>Members: <em><?php echo $_G['cache']['userstats']['totalmembers'];?></em><?php if($_G['cache']['userstats']['newsetuser']) { ?><span class="pipe">|</span>Welcome to new member: <em><a href="home.php?mod=space&amp;username=<?php echo rawurlencode($_G['cache']['userstats']['newsetuser']); ?>" target="_blank" class="xi2"><?php echo $_G['cache']['userstats']['newsetuser'];?></a></em><?php } ?></p>
<div class="y">
<?php if(!empty($_G['setting']['pluginhooks']['index_nav_extra'])) echo $_G['setting']['pluginhooks']['index_nav_extra'];?>
<?php if($_G['uid']) { ?><a href="forum.php?mod=guide&amp;view=my" title="My Threads" class="xi2">My Threads</a><?php } if(!empty($_G['setting']['search']['forum']['status'])) { if($_G['uid']) { ?><span class="pipe">|</span><?php } ?><a href="forum.php?mod=guide&amp;view=new" title="Last Replied" class="xi2">Last Replied</a><?php } ?>
</div>
</div>
<?php } ?>
...
<h4><span class="tit_goodtie"></span>Digest</h4>
...
<div class="bm_h cl">
<span class="o">
<img id="category_-1_img" src="<?php echo IMGDIR;?>/<?php echo $collapse['collapseimg_-1'];?>" title="Close/Open" alt="Close/Open" onclick="toggle_collapse('category_-1');" />
</span>
<h2><a href="forum.php?mod=collection&amp;op=my">My subscribed collections</a></h2>
</div>
...
<dd><em>Threads: <?php echo dnumber($colletion['threadnum']); ?></em>, <em>Comments: <?php echo dnumber($colletion['commentnum']); ?></em></dd>
<dd>
...
<div class="bm_h cl">
<span class="o">
<img id="category_0_img" src="<?php echo IMGDIR;?>/<?php echo $collapse['collapseimg_0'];?>" title="Close/Open" alt="Close/Open" onclick="toggle_collapse('category_0');" />
</span>
<h2><a href="home.php?mod=space&amp;do=favorite&amp;type=forum">My Favorite Forums</a></h2>
</div>
...
<dt><a href="<?php echo $forumurl;?>"<?php if($forum['redirect']) { ?> target="_blank"<?php } if($forum['extra']['namecolor']) { ?> style="color: <?php echo $forum['extra']['namecolor'];?>;"<?php } ?>><?php echo $forum['name'];?></a><?php if($forum['todayposts'] && !$forum['redirect']) { ?><em class="xw0 xi1" title="Today"> (<?php echo $forum['todayposts'];?>)</em><?php } ?></dt>
<?php if(empty($forum['redirect'])) { ?><dd><em>Threads: <?php echo dnumber($forum['threads']); ?></em>, <em>Posts: <?php echo dnumber($forum['posts']); ?></em></dd><?php } ?>
<dd>
<?php if($forum['permission'] == 1) { ?>
Private Forum
<?php } else { if($forum['redirect']) { ?>
<a href="<?php echo $forumurl;?>" class="xi2">Link URL</a>
...
<td>
<h2><a href="<?php echo $forumurl;?>"<?php if($forum['redirect']) { ?> target="_blank"<?php } if($forum['extra']['namecolor']) { ?> style="color: <?php echo $forum['extra']['namecolor'];?>;"<?php } ?>><?php echo $forum['name'];?></a><?php if($forum['todayposts'] && !$forum['redirect']) { ?><em class="xw0 xi1" title="Today"> (<?php echo $forum['todayposts'];?>)</em><?php } ?></h2>
<?php if($forum['description']) { ?><p class="xg2"><?php echo $forum['description'];?></p><?php } if($forum['subforums']) { ?><p>Sub-Forums: <?php echo $forum['subforums'];?></p><?php } if($forum['moderators']) { ?><p>Moderators: <span class="xi2"><?php echo $forum['moderators'];?></span></p><?php } ?>
<?php if(!empty($_G['setting']['pluginhooks']['index_favforum_extra'][$forum[fid]])) echo $_G['setting']['pluginhooks']['index_favforum_extra'][$forum[fid]];?>
</td>
<td class="fl_i">
...
<div class="bm_h cl">
<span class="o">
<img id="category_<?php echo $cat['fid'];?>_img" src="<?php echo IMGDIR;?>/<?php echo $cat['collapseimg'];?>" title="Close/Open" alt="Close/Open" onclick="toggle_collapse('category_<?php echo $cat['fid'];?>');" />
</span>
<?php if($cat['moderators']) { ?><span class="y">Category Moderator: <?php echo $cat['moderators'];?></span><?php } $caturl = !empty($cat['domain']) && !empty($_G['setting']['domain']['root']['forum']) ? 'http://'.$cat['domain'].'.'.$_G['setting']['domain']['root']['forum'] : '';?><h2><a href="<?php if(!empty($caturl)) { ?><?php echo $caturl;?><?php } else { ?>forum.php?gid=<?php echo $cat['fid'];?><?php } ?>" style="<?php if($cat['extra']['namecolor']) { ?>color: <?php echo $cat['extra']['namecolor'];?>;<?php } ?>"><?php echo $cat['name'];?></a></h2>
</div>
...
<div class="bm_h cl">
<span class="o">
<img id="category_-2_img" src="<?php echo IMGDIR;?>/<?php echo $collapse['collapseimg_-2'];?>" title="Close/Open" alt="Close/Open" onclick="toggle_collapse('category_-2');" />
</span>
<h2><a href="forum.php?mod=collection">Recommended collections</a></h2>
</div>
...
<div class="bm_h">
<?php if($detailstatus) { ?>
<span class="o"><a href="forum.php?showoldetails=no#online" title="Close/Open"><img src="<?php echo IMGDIR;?>/collapsed_no.gif" alt="Close/Open" /></a></span>
<h3>
<strong><a href="home.php?mod=space&amp;do=friend&amp;view=online&amp;type=member">Now Online</a></strong>
<!--vot-->					<span class="xs1">- <strong><?php echo $onlinenum;?></strong> &nbsp;
<!--vot-->					( Members: <strong><?php echo $membercount;?></strong>, Stealth: <strong><?php echo $invisiblecount;?></strong>,
<!--vot-->					Guests: <strong><?php echo $guestcount;?></strong> )
<!--vot-->					- Most onlines: <strong><?php echo $onlineinfo['0'];?></strong> at <strong><?php echo $onlineinfo['1'];?></strong>.</span>
</h3>
<?php } else { if(empty($_G['setting']['sessionclose'])) { ?>
<span class="o"><a href="forum.php?showoldetails=yes#online" title="Close/Open"><img src="<?php echo IMGDIR;?>/collapsed_yes.gif" alt="Close/Open" /></a></span>
<?php } ?>
<h3>
<strong>
...
Now Online
<?php } else { ?>
<a href="home.php?mod=space&amp;do=friend&amp;view=online&amp;type=member">Now Online</a>
<?php } ?>
</strong>
<span class="xs1">- Total <strong><?php echo $onlinenum;?></strong> Onlines
<?php if($membercount) { ?>- <strong><?php echo $membercount;?></strong> Members,<strong><?php echo $guestcount;?></strong> Guests<?php } ?>
- Most onlines <strong><?php echo $onlineinfo['0'];?></strong> at <strong><?php echo $onlineinfo['1'];?></strong>.</span>
</h3>
<?php } ?>
</div>
...
<?php } } else { ?>
<li style="width: auto">Only guests or invisible members are online.</li>
<?php } ?>
</ul>
</dd>
<?php } ?>
